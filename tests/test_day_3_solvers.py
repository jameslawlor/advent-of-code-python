...
# Additional test case to check if set_coordinates and set_symbol can be called independently
...
def get_symbols(day_3_test_input, day_3_expected_symbols_collection):
    test_symbols_list = get_symbols(day_3_test_input)
    output_symbol_positions = [sym.coordinates for sym in test_symbols_list]
    assert output_symbol_positions == day_3_expected_symbols_collection
...
def test_identify_part_numbers(
    ...
    test_parts_collection = identify_part_numbers(day_3_test_input, day_3_expected_symbols_collection)
    test_part_numbers = [part.part_number for part in test_parts_collection]
    day_3_expected_part_numbers = [part.part_number for part in day_3_expected_parts_collection]
    assert ( test_part_numbers == day_3_expected_part_numbers
    )


def test_calculate_sum_of_part_numbers(day_3_test_input, day_3_expected_symbols_collection):
    test_parts_list = identify_part_numbers(day_3_test_input, day_3_expected_symbols_collection)
